...
Use athlete measurements only when a relevant protocol and result were supplied. Self-ratings are context, not physiology. Keep LCM, SCM and SCY demands distinct, and never present a course conversion as an accepted entry time.
