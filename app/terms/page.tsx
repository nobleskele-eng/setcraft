    ...
    <PublicPageFrame>
      <article className="sc-legal-page">
        <header className="sc-legal-hero">
          ...
          <div><span>Effective {LEGAL_EFFECTIVE_DATE}</span><span>LaneLab Swim Studio</span></div>
        </header>
        <div className="sc-legal-layout">
          ...
          <div className="sc-legal-copy">
            <section className="sc-legal-summary"><strong>Plain-language summary</strong><p>LaneLab is a planning and decision-support workspace. It does not replace qualified coaching, medical advice, governing-body rules, or the user’s responsibility to check every workout and AI-assisted output before use.</p></section>
            <section id="acceptance"><span>01</span><h2>Acceptance and scope</h2><p>These Terms govern access to and use of the LaneLab website, coaching workspace, race-intelligence tools, AI features, exports, and related services (the “Service”). By creating an account or using the Service, you agree to these Terms and the <a href="/privacy">Privacy Policy</a>. If you use LaneLab for a club or organization, you confirm that you have authority to accept these Terms for that organization.</p></section>
            <section id="accounts"><span>02</span><h2>Accounts and security</h2><p>You must provide accurate account information, keep your password confidential, and promptly tell us about suspected unauthorized use. You are responsible for activity under your account. Do not share credentials or attempt to access another person’s account.</p><p>LaneLab is intended for coaches, club staff, and athletes capable of understanding these Terms. A minor may use the Service only with appropriate parent, guardian, coach, and club authorization.</p></section>
            <section id="coaching"><span>03</span><h2>Coaching and athlete responsibility</h2><p>Training plans, pace calculations, race analysis, equipment suggestions, and technique cues are informational tools. A qualified coach must assess the athlete, pool conditions, supervision, medical restrictions, readiness, intervals, recovery, and governing-body requirements before assigning or changing training.</p><p>LaneLab is not a medical device and does not provide diagnosis, treatment, return-to-sport clearance, or emergency advice. Stop and seek appropriate professional help when health or safety may be at risk.</p></section>
            ...
            <section id="content"><span>05</span><h2>Your content</h2><p>You retain ownership of workout text, athlete context, images, and other material you submit. You grant LaneLab a limited permission to process that content only as needed to operate, secure, and improve the requested Service. You are responsible for ensuring your content is lawful, accurate, and appropriately authorized.</p><p>AI prompts and images may be sent to configured technology providers to produce the requested response, as described in our Privacy Policy.</p></section>
            <section id="conduct"><span>06</span><h2>Acceptable use</h2><p>You may not misuse the Service, bypass access controls, introduce malicious code, probe other accounts, scrape the Service at disruptive volume, upload unlawful or infringing content, impersonate another person, or use LaneLab to facilitate harm, discrimination, surveillance, or unauthorized profiling.</p><p>You may not represent AI-generated material as an official governing-body result or knowingly use LaneLab output in a way that endangers an athlete.</p></section>
            <section><span>07</span><h2>LaneLab materials</h2><p>The Service design, software, branding, and original materials are owned by LaneLab or its licensors and are protected by applicable intellectual-property laws. These Terms give you a limited, revocable, non-transferable right to use the Service for its intended purpose; they do not transfer ownership.</p></section>
            ...
            <section id="liability"><span>09</span><h2>Disclaimers and limits</h2><p>To the extent permitted by law, the Service is provided “as is” and “as available,” without warranties that every output will be accurate or fit for a particular purpose. LaneLab is not responsible for coaching decisions, athlete outcomes, injuries, missed entries, or losses caused by reliance on unreviewed output.</p><p>Nothing in these Terms excludes rights or liabilities that cannot lawfully be excluded. To the extent permitted by law, LaneLab’s aggregate liability connected with the Service will not exceed the amount you paid LaneLab in the 12 months before the event giving rise to the claim.</p></section>
